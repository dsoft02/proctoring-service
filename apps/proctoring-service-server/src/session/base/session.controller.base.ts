...
import { ViolationWhereUniqueInput } from "../../violation/base/ViolationWhereUniqueInput";
...
export class SessionControllerBase {
  ...
  async findViolations(
    ...
    const query = plainToClass(ViolationFindManyArgs, request.query);
    const results = await this.service.findViolations(params.id, {
      ...query,
      select: {
        createdAt: true,
        description: true,
  ...
  @common.Post("/:id/violations")
  @nestAccessControl.UseRoles({
    resource: "Session",
    action: "update",
    possession: "any",
  })
  async connectViolations(
    @common.Param() params: SessionWhereUniqueInput,
    @common.Body() body: ViolationWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      violations: {
        connect: body,
  ...
  @common.Delete("/:id/violations")
  @nestAccessControl.UseRoles({
    resource: "Session",
    action: "update",
    possession: "any",
  })
  async disconnectViolations(
    @common.Param() params: SessionWhereUniqueInput,
    @common.Body() body: ViolationWhereUniqueInput[]
  ): Promise<void> {
    const data = {
